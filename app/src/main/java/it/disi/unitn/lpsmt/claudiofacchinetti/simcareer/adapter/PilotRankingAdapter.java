...
public class PilotRankingAdapter extends BaseAdapter {

    private List<PilotRankingItem> ranking;
    private Context context;

    public PilotRankingAdapter(List<PilotRankingItem> ranking, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PilotRankingItem item = (PilotRankingItem) this.getItem(position);
